...
# rel_path_to_libs = '../' * 5  # number of relative levels up to library
# if not rel_path_to_libs in sys.path:
#     sys.path.append(rel_path_to_libs)

# add absolute path to folder that contains all custom modules
# abs_path_to_libs = ('/home/laigner/shares/gp/Projects/TEM_modeling/EMPYMOD/' +
#                     'publications/Aigner_paper1/03-repo_scripts/')
# abs_path_to_libs = (r"C:/Users/lukas/Documents/geocloud/" + 
#                     '01-work_main/09-python_coding/')
...
proj_dir = r"00_data/selected/"
path = std_dir + proj_dir
path2coord = path

# filename = '20240227_hw-perp-25.tem'
# filename = '240715-tests.tem'
# filename = '240715-S1.tem'
filename = '240715-N6S23.tem'

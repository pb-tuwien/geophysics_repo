...
noise_floors = np.arange(0.03, 0.15, 0.02) # Code OV paper
# noise_floors = np.arange(0.01, 0.09, 0.02)
...
thk_lu = (1, 15)    # boundaries for layer thicknesses

...
time_ranges = np.array([[60., 400.], [25., 500.]])  # in us

thk_lu = (5, 100)    # boundaries for layer thicknesses
...
gen_max_depth = 'constraint'
inlay_thk = np.r_[5.0, 70.0, 70.0]
inlay_res = np.r_[1000.0, 3000.0, 3000.0, 300.0]
inlay_mpa = np.r_[0.01, 0.6, 0.6, 0.01]
inlay_taup = np.r_[1e-6, 5e-4, 5e-4, 1e-6]
inlay_c = np.r_[0.01, 0.9, 0.9, 0.01]

constr_thk = np.r_[1, 0, 0]
